...
const footerItem = document.querySelectorAll('.footer-item-title');
const footerItemLink = document.querySelectorAll('.footer-item-link');
[...footerItem].forEach((item) => item.addEventListener('click', toggleFooterItem));
function toggleFooterItem(e){
  [...footerItemLink].forEach((item)=>item.classList.toggle('active'));
}
